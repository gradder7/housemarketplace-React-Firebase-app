...
export default function EditListing() {
  ...
  const onSubmit = async (e) => {
    ...
    const storeImage = async (image) => {
      return new Promise((resolve, reject) => {
        ...
        // reference and path name in storage
    ...
    //all the images at state will be passed in promise.all and  every single image will be passed in function and return the download url of that image.
  ...
  const onMutate = (e) => {
    ...
    if (!e.target.files) {
      setFormData((prevState) => ({
        ...prevState,
        // ?? means if null means not true and false than its gonna use right value
